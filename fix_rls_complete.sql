-- COMPLETE FIX: Database functions for all group operations
-- This completely bypasses RLS issues

-- 1. Drop ALL policies on group_members table
DO $$
DECLARE
    pol RECORD;
BEGIN
...
-- 2. Disable RLS on group_members entirely (we'll use functions instead)
ALTER TABLE public.group_members DISABLE ROW LEVEL SECURITY;

-- 3. Create group with admin function
...
-- 4. Join group by invite code function
